...
function updateImageURL() {
    // Get all select elements with the class .variant-list
    let selects = document.querySelectorAll('.variant-list select');
...
document.querySelectorAll('.variant-list select').forEach(function(select) {
